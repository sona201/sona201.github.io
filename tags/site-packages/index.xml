...
<rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom">
    <channel>
        <title>site-packages on Ricardo</title>
        <link>https://sona201.github.io/tags/site-packages/</link>
        <description>Recent content in site-packages on Ricardo</description>
        <generator>Hugo -- gohugo.io</generator>
        <language>zh-CN</language>
        <lastBuildDate>Wed, 22 May 2024 14:20:01 +0800</lastBuildDate><atom:link href="https://sona201.github.io/tags/site-packages/index.xml" rel="self" type="application/rss+xml" /><item>
...
&lt;p&gt;顺便说下&lt;code&gt;PATH&lt;/code&gt;是用来找==可执行程序==的搜索路径，假如你在终端运行命令&lt;code&gt;my_cmd&lt;/code&gt;，系统会依次扫描&lt;code&gt;PATH&lt;/code&gt;中的路径，看&lt;code&gt;my_cmd&lt;/code&gt;是否在于该路径下，所以如果是提示找不到程序或命令无法识别，那你就要看路径是否加到&lt;code&gt;PATH&lt;/code&gt;里了。&lt;/p&gt;
